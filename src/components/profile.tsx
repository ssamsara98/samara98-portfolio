          ...
          <Fade right>
            <>
              <Text textAlign="justify" fontSize={{ base: 'xl', md: '3xl' }}>
                Someone who passionate about programming and solving challenging problems, proficient in an assortment
                of technologies and able to self-manage during independent projects, as well as collaborate in a team
                setting.
              </Text>
              <Text textAlign="justify" fontSize={{ base: 'xl', md: '3xl' }}>
